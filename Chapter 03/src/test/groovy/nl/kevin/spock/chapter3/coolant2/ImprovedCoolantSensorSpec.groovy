package nl.kevin.spock.chapter3.coolant2

import nl.kevin.spock.chapter3.coolant.TemperatureReader
import nl.kevin.spock.chapter3.coolant.TemperatureReadings
...
class ImprovedCoolantSensorSpec extends spock.lang.Specification {
    ...
    def "Testing of all 3 sensors with temperatures that rise and fall"() {
        ...
        TemperatureReadings prev = new TemperatureReadings(sensor1Data: previousTemp[0], sensor2Data: previousTemp[1], sensor3Data: previousTemp[2])
        TemperatureReadings current = new TemperatureReadings(sensor1Data: currentTemp[0], sensor2Data: currentTemp[1], sensor3Data: currentTemp[2])
        TemperatureReader reader = Stub(TemperatureReader)
        ...
        when: "we ask the status of temparature control"
        monitor.readSensor()
        monitor.readSensor()
