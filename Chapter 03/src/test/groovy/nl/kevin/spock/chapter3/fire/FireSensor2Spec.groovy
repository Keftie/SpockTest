package nl.kevin.spock.chapter3.fire
...
class FireSensor2Spec extends spock.lang.Specification {
    ...
    def "If less than half of the sensors are actie the alarm should sound as a precaution"() {
    ...
    def "If more than half pf sensors are active we hav a fire"() {
        given: "that seven sensors are active"
        FireEarlyWarning2 fireEarlyWarning = new FireEarlyWarning2()
